	...
	<div class="mt-6">
		<div class="card card--dark card--thick bg-pattern-1 min-h-48">
			<div class="card--content">
				...
				<div class="flex flex-row md:gap-x-8">
					<div class="w-full">
					...
					<div class='max-w-[640px] min-w-[440px] flex flex-col items-end justify-end gap-4'>
						<!-- Bar forecast -->
						<div class="w-full">
							<div class="text-sm d flex flex-row justify-between"><h3 class="font-semibold">Expected Income</h3><div class="flex flex-row gap-x-2"><span>$1,340.28</span>/<span>$3,450.99</span></div></div>
							<div class="relative mt-1 flex flex-row items-center">
								<div class="h-3 w-full rounded-full bg-black/45"></div><CircleCheck class="w-4 h-4 ml-2 -mr-1 text-white/55" />
								<div class="absolute left-0.5 h-2 w-24 rounded-full bg-white/75"></div>
							</div>
						</div>
						<!-- Bar forecast -->
						<div class="w-full ">
							...
							<div class="relative mt-1 flex flex-row items-center">
								<div class="h-3 w-full rounded-full bg-black/45"></div><CircleCheck class="w-4 h-4 ml-2 -mr-1 text-white/55" />
								<div class="absolute left-0.5 h-2 w-48 rounded-full bg-white/75"></div>
							</div>
						</div>
						<!-- Bar forecast -->
						<div class="w-full ">
							<div class="text-sm d flex flex-row justify-between"><h3 class="font-semibold">Expected Income</h3><div class="flex flex-row gap-x-2"><span>$1,340.28</span>/<span>$3,450.99</span></div></div>
							<div class="relative mt-1 flex flex-row items-center">
								<div class="h-3 w-full rounded-full bg-black/45"></div><CircleCheck class="w-4 h-4 ml-2 -mr-1 text-emerald-400" />
								<div class="absolute  left-0.5 right-5 h-2 rounded-full bg-emerald-400"></div>
							</div>
						</div>
